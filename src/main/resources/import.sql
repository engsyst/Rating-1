...
(default,	"4.18 Керівництво науковою роботою студентів з підготовкою: матеріалів Міжнародної зимовою школи з програмування»",	2,	"100",	"годин",	"1",	"ДА",	"друковані мате-ріали",	 null),
(default,	"4.19 Керівництво науковою роботою студентів з підготовкою: експонатів на виставки; презента-ції; конкурси тощо.",	2,	"30",	"годин",	"1",	"експонат",	"експонати та його опис",	 null),
(default,	"4.20 Виконання ініціативних і пошуко-вих наукових досліджень зі звітніс-тю за формами: електронний науковий словник; електронний науковий довідник",	2,	"90",	"годин",	"1",	"ДА",	"тверда копія",	 null),
(default,	"4.21 Виконання ініціативних і пошуко-вих наукових досліджень зі звітніс-тю за формами: наукові статті та доповіді в елект-ронних виданнях",	2,	"80",	"годин",	"1",	"ДА",	"тверда копія",	 null),
(default,	"4.22 Виконання ініціативних і пошуко-вих наукових досліджень зі звітніс-тю за формами: електронні веб–сторінки про нау-кові дослідження (розробки)",	2,	"5",	"годин",	"1",	"сторінку",	"посилання на веб–сторінку",	 null),
(default,	"4.23 Пошук електронних джерел інфор-мації за темою наукових досліджень",	2,	"1",	"година",	"10",	"джерел",	"тверда копія пе-реліку джерел",	 null),
(default,	"4.24 Розробка бізнес–планів інновацій-них проектів",	2,	"50",	"годин",	"1",	"бізнес-план",	"бізнес-план",	 null);
