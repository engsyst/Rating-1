...
CREATE TABLE `author` (
  ...
  CONSTRAINT `fk_Author_Employee1` FOREIGN KEY (`EmployeeId`) REFERENCES `employee` (`EmployeeId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Author_Student1` FOREIGN KEY (`StudentId`) REFERENCES `student` (`StudentId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
  ENGINE = InnoDB
...
CREATE TABLE `category` (
  ...
  CONSTRAINT `fk_Category_Category1` FOREIGN KEY (`ParentId`) REFERENCES `category` (`CategoryId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
  ENGINE = InnoDB
...
CREATE TABLE `doc` (
  ...
  CONSTRAINT `fk_doc_work1` FOREIGN KEY (`work_WorkId`) REFERENCES `work` (`WorkId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
  ENGINE = InnoDB
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `fk_User_Employee1` FOREIGN KEY (`EmployeeId`) REFERENCES `employee` (`EmployeeId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE `work` (
  ...
  CONSTRAINT `fk_Work_Activity1` FOREIGN KEY (`ActivityId`) REFERENCES `activity` (`ActivityId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Work_Category1` FOREIGN KEY (`CategoryId`) REFERENCES `category` (`CategoryId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_work_employee1` FOREIGN KEY (`EmployeeId`) REFERENCES `employee` (`EmployeeId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
  ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COMMENT = 'Represent each work of employee, that should be considered';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `workauthor` (
  ...
  CONSTRAINT `fk_Work_has_Author_Author1` FOREIGN KEY (`AuthorId`) REFERENCES `author` (`AuthorId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Work_has_Author_Work1` FOREIGN KEY (`WorkId`) REFERENCES `work` (`WorkId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)
  ENGINE = InnoDB
